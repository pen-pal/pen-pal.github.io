  ...
  projects: [
    {
      ...
      desc: "End-to-end SOC2 & ISO compliance infrastructure controls covering access control, audit logging, secrets management, and continuous monitoring.",
    ...
    },
    {
      ...
      desc: "Production Kubernetes platform enabling GPU sharing across multiple pods for ML inference workloads.",
  ...
  resumeExp: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Architected <strong>Snowflake Container Services</strong> for cross-cloud distribution.",
    ...
    },
    {
      ...
      bullets: [
        ...
        "Multi-cloud migrations to <strong>AWS, GCP, Azure, DigitalOcean</strong>.",
        "Deployed <strong>ArgoCD + Terraform GitOps pipelines</strong> for auditable infrastructure.",
    ...
    },
    {
      ...
      company: "Innovatetech Pvt. Ltd.",
      bullets: [
        "<strong>50% AWS cost reduction</strong> across five accounts.",
        "Built <strong>security pipelines</strong> with SonarQube, Trivy, Checkov.",
        "Introduced <strong>per-PR immutable preview environments</strong>.",
        "<strong>Managed team of 5 DevOps engineers</strong>.",
      ],
    },
    {
      ...
      company: "IDenTV · Video Intelligence Platform",
      bullets: [
        "Reduced <strong>AWS spend from $24K to $12K/mo</strong> (50%).",
        "Automated infra across <strong>AWS and Oracle Cloud</strong> via Terraform.",
        "Implemented <strong>GPU sharing across Kubernetes pods</strong> for ML workloads.",
      ],
    },
  ],
